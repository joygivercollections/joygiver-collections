...
import { wholesaleAudienceLabel, wholesaleCategoryLabel, wholesaleConditionLabel } from "../components/wholesale-labels";
...
export function WholesaleDetailPage() {
  ...
  const audience = wholesaleAudienceLabel(item.audiences);
    ...
    <main className="wholesale-detail page-width">
      ...
      <div className="product-detail__grid">
        ...
        <section className="product-info">
          <div className="product-info__badges"><span className="condition-badge">{wholesaleConditionLabel(item.conditionScope)}</span>{item.promoEligible ? <span className="condition-badge condition-badge--promo">Promo</span> : null}{sold ? <span className="condition-badge condition-badge--sold">Sold</span> : null}</div>
          ...
          <p>{item.pieceCount} pieces · {wholesaleCategoryLabel(item.categories)}</p><p className="product-info__description">{item.description}</p>
